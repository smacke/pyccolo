...
from pyccolo.ipython_extension import (
...
before_assert = TraceEvent.before_assert
after_assert = TraceEvent.after_assert
...
before_for_iter = TraceEvent.before_for_iter
after_for_iter = TraceEvent.after_for_iter
...
before_left_binop_arg = TraceEvent.before_left_binop_arg
after_left_binop_arg = TraceEvent.after_left_binop_arg
before_right_binop_arg = TraceEvent.before_right_binop_arg
...
after_boolop = TraceEvent.after_boolop
